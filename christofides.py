...
def travel_time(x1, x2, y1, y2):
    return math.sqrt((x1 - x2)**2 + (y1 - y2)**2)

def cost(start, end):
    dist = travel_time(start[0], start[1], end[0], end[1])
    time = end[5]
    util = end[4]
    ...
    for this in range(len(data)):
        for another_point in range(len(data)):
            if this != another_point:
                ...
                graph[this][another_point] = cost(data[this], data[another_point])
...
def read_input():
    ...
    for i in range(N):
        ...
        attractions.append([x, y, open, close, util, duration])
    print(attractions)
